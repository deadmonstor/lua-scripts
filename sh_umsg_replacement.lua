...
if ( SERVER ) then
	local networking = {}
	networking.Senders = {
		[ TYPE_CONVAR ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write ConVar( 27 ) value!" ); end;
		[ TYPE_COUNT ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write Amount of TYPE_* enums( 39 ) value!" ); end;
		[ TYPE_DAMAGEINFO ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write CTakeDamageInfo( 15 ) value!" ); end;
		[ TYPE_DLIGHT ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write TYPE_DLIGHT( 30 ) value!" ); end;
		[ TYPE_EFFECTDATA ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write CEffectData( 16 ) value!" ); end;
		[ TYPE_FILE ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write File( 34 ) value!" ); end;
		[ TYPE_FUNCTION ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write function( 6 ) value!" ); end;
		[ TYPE_IMESH ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write IMesh( 28 ) value!" ); end;
		[ TYPE_INVALID ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write Invalid type( -1 ) value!" ); end;
		[ TYPE_LIGHTUSERDATA ]		= function( _data )	debug.print( "Networking:SenderError", "Can't write TYPE_LIGHTUSERDATA( 32 ) value!" ); end;
		[ TYPE_MATERIAL ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write IMaterial( 21 ) value!" ); end;
		[ TYPE_MATRIX ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write VMatrix( 29 ) value!" ); end;
		[ TYPE_MOVEDATA ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write CMoveData( 17 ) value!" ); end;
		[ TYPE_PANEL ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write Panel( 22 ) value!" ); end;
		[ TYPE_PARTICLE ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write CLuaParticle( 23 ) value!" ); end;
		[ TYPE_PARTICLEEMITTER ]	= function( _data )	debug.print( "Networking:SenderError", "Can't write CLuaEmitter( 24 ) value!" ); end;
		[ TYPE_PHYSOBJ ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write PhysObj( 12 ) value!" ); end;
		[ TYPE_PIXELVISHANDLE ]		= function( _data )	debug.print( "Networking:SenderError", "Can't write pixelvis_handle_t( 30 ) value!" ); end;
		[ TYPE_RECIPIENTFILTER ]	= function( _data )	debug.print( "Networking:SenderError", "Can't write CRecipientFilter( 18 ) value!" ); end;
		[ TYPE_RESTORE ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write IRestore( 14 ) value!" ); end;
		[ TYPE_SAVE ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write ISave( 13 ) value!" ); end;
		[ TYPE_SOUND ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write TYPE_SOUND( 30 ) value!" ); end;
		[ TYPE_TEXTURE ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write ITexture( 24 ) value!" ); end;
		[ TYPE_THREAD ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write thread( 8 ) value!" ); end;
		[ TYPE_USERCMD ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write CUserCmd( 19 ) value!" ); end;
		[ TYPE_USERMSG ]			= function( _data )	debug.print( "Networking:SenderError", "Can't write TYPE_USERMSG( 26 ) value!" ); end;
		[ TYPE_VIDEO ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write IVideoWriter( 33 ) value!" ); end;

		[ TYPE_NIL ]				= function( _data )	debug.print( "Networking:SenderError", "Can't write NIL( 0 ) value!" ); end;
